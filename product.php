            ...
            <div class="row">
                ...
                <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                    <div class="ht__product__dtl">
                        ...
                        <ul class="pro__prize">
                            <!-- <li class="old__prize a-text-strike">₹<?php echo $list['mrp'] ?></li> -->
                            <!--<li class="old__prize a-text-strike">₹<?php echo $get_product['0']['mrp'] ?></li>-->
                            <li>MRP : ₹<?php echo $get_product['0']['price'] ?></li>
                        </ul>
                        ...
                        <div class="ht__pro__desc">
                            <div class="sin__desc">
                             ...
                             <div class="sin__desc"><?php echo $get_product['0']['qty'] ?><br>
                                <p><span>Qty:</span>
                                    <select id="qty">
                                        <option>1</option>
                                        <option>2</option>
