...
<div class="ht__bradcaump__area" style="    background-color: aquamarine;">
    <div class="ht__bradcaump__wrap" style="		align-items: unset;		display: contents;">
        <div class="container">
            <div class="row" style="margin-left: -155px;margin-right: -120px;">
                <div class="col-xs-12">
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-name"><a href="#"><?php echo $row['name'] ?></a>
                                            <ul class="pro__prize">
                                                ...
                                                <!--<li class="old__prize a-text-strike"><?php echo $row['mrp'] ?></li>-->
                                                <li>MRP: ₹<?php echo $row['price'] ?></li>
                                            </ul>
                                        </td>
