...
if (isset($_POST['submit'])) {
	...
	$user_no= get_safe_value($con, $_POST['phone']);
	foreach ($_SESSION['cart'] as $key => $val) {
		$productArr = get_product($con, '', '', $key);
		$price = $productArr[0]['price'];
		$qty = $val['qty'];
		$cart_total = $cart_total + ($price * $qty);
		$total_pay = $cart_total +20;
	}
	...
	mysqli_query($con, "insert into `order`(user_id,user_name,user_no,address,city,pincode,payment_type,payment_status,order_status,added_on,total_price,txnid) values('$user_id','$user_name','$user_no','$address','$city','$pincode','$payment_type','$payment_status','$order_status','$added_on','$total_price','$txnid')");
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="order-details">
					...
					<div class="ordre-details__total">
						<h5>Total Amount</h5>
						<span class="price">₹<?php echo $total_pay ?></span>
					</div>
				</div>
			</div>
		</div>
